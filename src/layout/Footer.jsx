      ...
      <footer className="text-gray-300 py-4 bg-[#08172E]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="px-5">
            ...
            <p className="text-center md:text-justify"><span className="font-bold text-lg block md:inline">Dirección: </span>Calle Gabriel García Márquez #533, Real Vista Hermosa, 28018 Colima, Col.</p>
